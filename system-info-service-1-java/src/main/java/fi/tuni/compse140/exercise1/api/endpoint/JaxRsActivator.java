...
@OpenAPIDefinition(
        info = @Info(title = "System Info Service 1 - Java",
                description = "Service1 acts as an HTTP server accessible, responding to external client requests by collecting system information from both itself and Service2. It communicates with Service2 to retrieve its IP address, running processes, available disk space, and uptime, and returns the combined data to the client.",
                version = "1.0",
